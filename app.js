function App() {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Nav, {
    ...
    onJoin: scrollToCierre
  }), React.createElement(Problema, null), React.createElement(Transformacion, null), React.createElement(Programa, null), React.createElement(Manifiesto, null), React.createElement(Precio, {
    onJoin: scrollToCierre
